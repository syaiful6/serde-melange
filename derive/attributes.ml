           ...
           (function
             ...
             | ( { txt = Lident "content"; _ }
               ...
               let new_mode =
                 ...
                 | _ ->
                   failwith
                     "[ppx_serde] You can only use the 'content' attribute \
                      after the 'tag' attribute."
               in
             ...
             | { txt = Lident "rename_all"; _ }, expr ->
               let rename_value =
                 ...
                 | [%expr "SCREAMING_SNAKE_CASE"] -> Some `SCREAMING_SNAKE_CASE
                 | [%expr "SCREAMING-KEBAB-CASE"] -> Some `SCREAMING_KEBAB_CASE
                 | _ ->
                   failwith
                     (Format.asprintf
             ...
             | { txt = Lident txt; _ }, _ ->
               failwith (Format.sprintf "[ppx_serde] Unknown attribute %S" txt)
             | _ -> ())
           fields
       | _ -> ())
    serde_attr;
